...
class SiliconBluePlatform(TemplatedPlatform):
    """
    .. rubric:: Project Unnamed toolchain
    ...
    ``AMARANTH_ENV_PRJUNNAMED``, if present.
    ...
    _nextpnr_required_tools = [
        "nextpnr-ice40",
        "icepack",
    ]
    _nextpnr_file_templates = {
    ...
    # prjunnamed templates

    _prjunnamed_required_tools = [
        "prjunnamed",
        *_nextpnr_required_tools,
    ]
    _prjunnamed_file_templates = {
        "{{name}}.uir": r"""
            ; {{autogenerated}}
            target "siliconblue"
            {{emit_unnamed()}}
    ...
    _prjunnamed_command_templates = [
        r"""
        {{invoke_tool("prjunnamed")}}
            {{name}}.uir
            {{name}}.json
        """,
        *_nextpnr_command_templates
    ...
    def __init__(self, *, toolchain="IceStorm"):
        ...
        assert toolchain in ("prjunnamed", "IceStorm", "LSE-iCECube2", "Synplify-iCECube2")
    ...
    def _toolchain_env_var(self):
        if self.toolchain in ("IceStorm", "prjunnamed"):
    ...
    def required_tools(self):
        if self.toolchain == "prjunnamed":
            return self._prjunnamed_required_tools
    ...
    def file_templates(self):
        if self.toolchain == "prjunnamed":
            return self._prjunnamed_file_templates
        if self.toolchain == "IceStorm":
    ...
    def command_templates(self):
        if self.toolchain == "prjunnamed":
            return self._prjunnamed_command_templates
        if self.toolchain == "IceStorm":
